...
import com.kezuo.core.decoder.MessageDecoder;
...
import com.kezuo.core.encoder.MessageEncoder;
import com.kezuo.device.SyncFuture;
import com.kezuo.exception.ClientException;
import com.kezuo.handler.ClientHandler;
import com.kezuo.handler.LinkCheckHandler;
import com.kezuo.handler.RegisterHandler;
import com.kezuo.util.CommonUtil;
...
public class Client {
    ...
    public Message sendMessage(ObjectMessage message, int seconds) throws ClientException {
        ...
        responseFuture.setResponse(null);//add by zlzuo 180908,防止取了旧的。
        responseFuture.setLatch(new CountDownLatch(1));//add by zlzuo 180909
