 ...
 * 
 */
package com.kezuo.core.convertor.impl;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

import com.kezuo.core.convertor.MessageConvertor;
import com.kezuo.core.dto.Address;
import com.kezuo.core.dto.FrameConstant;
...
public class DefaultMessageConvertor implements MessageConvertor<ObjectMessage> {
	...
	public List<Message> toByteMessage(ObjectMessage t) {
		...
		if(content == null){
			System.err.println("消息异常："+t.toString());
			return list;
		}
